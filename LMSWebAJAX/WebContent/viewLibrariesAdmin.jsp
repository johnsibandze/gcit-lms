...
<%
	...
	if (request.getAttribute("libraries") != null) {
		...
		libraries = adminService.readLibraries(0, AdminServlet.PAGE_SIZE);
	}
%>
...
<nav>
	<ul class="pagination">
		<li><a href="pageLibrariesAdmin?pageNo=1">1</a></li>
		<li><a href="pageLibrariesAdmin?pageNo=2">2</a></li>
		<li><a href="pageLibrariesAdmin?pageNo=3">3</a></li>
		<li><a href="pageLibrariesAdmin?pageNo=4">4</a></li>
